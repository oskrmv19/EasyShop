...
class DetailFragment : Fragment() {
    ...
    private fun setupToolbar() {
        (requireActivity() as com.oskr19.easyshop.MainActivity).supportActionBar?.setDisplayShowTitleEnabled(true)
        (requireActivity() as com.oskr19.easyshop.MainActivity).supportActionBar?.customView?.showHide(false)
    }
